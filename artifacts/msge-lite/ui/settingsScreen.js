  ...
  const isoRows = Object.entries(ISO_LABELS).map(([key, label]) => `
    <div class="diag-sub-row">
      ...
      <label class="toggle-switch toggle-switch--sm">
        <input type="checkbox" class="diag-iso-toggle" data-iso="${key}" ${iso[key] ? 'checked' : ''} ${!diagOn ? 'disabled' : ''} aria-label="Toggle Isolation for ${key}" />
  ...
  return `
    <section class="settings-group dev-tools">
      ...
      <div class="settings-row dev-tool-toggle-row" data-key="infinite">
        ...
        <label class="toggle-switch">
          <input type="checkbox" id="dev-infinite-toggle" ${infinite ? 'checked' : ''} aria-label="Toggle Infinite Balance" />
          <span class="toggle-slider"></span>
        </label>
      </div>
    ...
    <div class="settings-body">
      <section class="settings-group">
        <div class="settings-row" data-key="ambientAudio">
          ...
          <label class="toggle-switch">
            <input type="checkbox" ${s.ambientAudio ? 'checked' : ''} aria-label="Toggle Ambient Vendor Audio" />
            <span class="toggle-slider"></span>
          </label>
        </div>
        ...
        <div class="settings-row" data-key="haptics">
          ...
          <label class="toggle-switch">
            <input type="checkbox" ${s.haptics ? 'checked' : ''} aria-label="Toggle Haptic Feedback" />
            <span class="toggle-slider"></span>
          </label>
        </div>
        ...
        <div class="settings-row" data-key="reducedMotion">
          ...
          <label class="toggle-switch">
            <input type="checkbox" ${s.reducedMotion ? 'checked' : ''} aria-label="Toggle Reduced Motion" />
            <span class="toggle-slider"></span>
          </label>
        </div>
      </section>
